...
--> statement-breakpoint
ALTER TABLE "subjects" ADD CONSTRAINT "subjects_deparment_id_departments_id_fk" FOREIGN KEY ("deparment_id") REFERENCES "public"."departments"("id") ON DELETE restrict ON UPDATE no action;